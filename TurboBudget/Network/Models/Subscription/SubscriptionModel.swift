...
class SubscriptionModel: Codable, Identifiable, Equatable, ObservableObject, Hashable {
    ...
    // Initialiseur
    init(id: Int? = nil, name: String? = nil, amount: Double? = nil, frequency: Int? = nil, frequencyDate: String? = nil, frequencyDay: String? = nil, categoryID: String? = nil, subcategoryID: String? = nil) {
        self.id = id
        self.name = name
        self.amount = amount
