//
//  CreateTransactionForSavingsAccountView.swift
//  CashFlow
//
...
struct CreateTransactionForSavingsAccountView: View {
    
    @StateObject private var viewModel: CreateTransactionForSavingsAccountViewModel
        ...
        NavigationStack {
            ScrollView {
                VStack(spacing: 24) {
                    ...
                    TransactionTypePicker(selected: .constant(.income))
...
// MARK: - Preview
#Preview {
    CreateTransactionForSavingsAccountView(savingsAccount: .mockSavingsAccount)
}
