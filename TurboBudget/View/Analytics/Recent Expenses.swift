...
struct RecentExpensesView: View {
    ...
    @ObservedObject var predefinedCategories = PredefinedObjectManager.shared
    ...
    var body: some View {
        ...
        .padding(update ? 0 : 0)
        .background(Color.colorBackground.edgesIgnoringSafeArea(.all))
        .navigationTitle(NSLocalizedString("word_expenses", comment: ""))
...
struct RecentExpensesView_Previews: PreviewProvider {
    ...
    static var previews: some View {
        RecentExpensesView(account: $previewAccount, update: $prevUpdate)
    }
}
