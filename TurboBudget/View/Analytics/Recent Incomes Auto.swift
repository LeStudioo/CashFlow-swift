//
//  RecentIncomesAutomationsView.swift
//  CashFlow
//
...
struct RecentIncomesAutomationsView: View {
    ...
    var body: some View {
        ...
        .padding(update ? 0 : 0)
        .background(Color.colorBackground.edgesIgnoringSafeArea(.all))
        .navigationTitle(NSLocalizedString("word_automations_incomes", comment: ""))
...
//MARK: - Preview
struct RecentIncomesAutomationsView_Previews: PreviewProvider {
    
    @State static var prevUpdate: Bool = false
    @State static var previewAccount: Account? = previewAccount1()
    
    static var previews: some View {
        RecentIncomesAutomationsView(account: $previewAccount, update: $prevUpdate)
    }
}
