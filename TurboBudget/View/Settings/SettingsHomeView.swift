        ...
        NavStack(router: router) {
            Form {
                ...
                Section {
                    ...
                    Button(action: {
                        URLManager.Setting.suggestFeature()
                    }, label: {
                        CellSettingsView(
                            icon: "wand.and.stars",
                            backgroundColor: Color.purple,
                ...
                Section {
                    ...
                    Button(action: {
                        URLManager.Setting.showDeveloperAccount()
                    }, label: {
                        CellSettingsView(
                ...
                Section {
                    Button(action: {
                        router.pushSettingsDangerZone(account: account)
                    }, label: {
                        CellSettingsView(
                            icon: "trash.fill",
                            backgroundColor: Color.red,
