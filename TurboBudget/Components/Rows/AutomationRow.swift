        ...
        SwipeView(label: {
            HStack {
                Circle()
                    ...
                    .frame(width: 50)
                    .overlay {
                        if let category = subscription.category, let subcategory = subscription.subcategory {
                            Circle()
                        ...
                        } else if let category = subscription.category, subscription.subcategory == nil {
                            Circle()
                                .foregroundStyle(category.color)
                                .shadow(radius: 4, y: 4)
                                .frame(width: 34)
        ...
        .alert("transaction_cell_delete_auto".localized, isPresented: $isDeleting, actions: {
            ...
            Button(
                ...
                action: {
                    ...
                    //                        automationRepo.deleteAutomation(automation)
                },
...
// MARK: - Preview
#Preview {
    AutomationRow(subscription: .mockClassicSubscriptionExpense)
}
