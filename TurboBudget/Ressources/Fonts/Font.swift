...
extension Font {
    struct Title {
        static let semibold: Font = Font.custom("PlusJakartaSans-SemiBold", size: 24)
    }
    struct Subtitle {
        static let medium: Font = Font.custom("PlusJakartaSans-Medium", size: 20)
    }
    struct Button {
        static let text: Font = Font.custom("PlusJakartaSans-SemiBold", size: 18)
    }
    struct Body {
        static let bold: Font = Font.custom("PlusJakartaSans-Bold", size: 16)
        static let semibold: Font = Font.custom("PlusJakartaSans-SemiBold", size: 16)
    }
    struct Text {
        static let semibold: Font = Font.custom("PlusJakartaSans-SemiBold", size: 14)
        static let medium: Font = Font.custom("PlusJakartaSans-Medium", size: 14)
        static let regular: Font = Font.custom("PlusJakartaSans-Regular", size: 14)
    }
    struct Caption {
        static let medium: Font = Font.custom("PlusJakartaSans-Medium", size: 12)
    }
}
//
//// Regular
